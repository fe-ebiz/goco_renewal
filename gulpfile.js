...
function templateApp() {
    return src(config.template.src_app, { since: lastRun(template) })
        .pipe(fileinclude({
            prefix: '@@',
            basepath: '@file'
            // basepath: '@root'
...
exports.css = css;
exports.js = js;
exports.serve = parallel(series(parallel(template, templateM, templateApp), sassDev, css, js, img, etc, bSync), watchingDev);
exports.build = parallel(series(parallel(template, templateM, templateApp), sassPrd, css, js, img, etc, bSync), watchingPrd);
